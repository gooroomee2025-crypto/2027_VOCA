...
(function () {
  ...
  var STORAGE_KEY = 'app2_2027ss_voca_state_v1';
  ...
  /* ---------------------------------------------------------
     small DOM helpers (Fixed style attribute bug)
  --------------------------------------------------------- */
  function h(tag, attrs, children) {
    ...
    Object.keys(attrs).forEach(function (k) {
      ...
      if (k === 'class') el.className = v;
        ...
        if (typeof v === 'object') {
          Object.keys(v).forEach(function (styleKey) {
            el.style[styleKey] = v[styleKey];
          });
        } else {
  ...
  var wordsViewMode = 'list';
  var wordsSortMode = 'default';
  var wordsSortSeed = [];
  ...
  function renderWords() {
    ...
    if (studiedCount >= WORDS_PER_DAY) {
      wrap.appendChild(h('div', { class: 'words-complete-banner' }, [
        ...
        text('div', 'badge-title', 'DAY ' + String(day).padStart(2, '0') + ' \uD559\uC2B5 \uC644\uB8CC \uBC33\uC9C0 \uD68D\uB4DD'),
  ...
  /* ---------------------------------------------------------
     Words page — list view (Fixed reveal toggle state)
  --------------------------------------------------------- */
  var wordsListRevealed = {};
  ...
  function buildWordListRow(w) {
    ...
    var body = h('div', {
      ...
      onclick: function () { 
        wordsListRevealed[w.id] = !revealed; 
        render(); 
      }
    }, bodyChildren);
  ...
  /* ============================================================
     NOTES (Fixed type mismatch on daysPresent array)
  ============================================================ */
  var notesTab = 'wrong';
  var notesDayFilter = 'all';
  ...
  function renderNotes() {
    ...
    Object.keys(grouped).map(Number).sort(function (a, b) { return a - b; }).forEach(function (day) {
  ...
  function renderSettings() {
    ...
    wrap.appendChild(h('div', { class: 'settings-group' }, [
      ...
      buildSettingsRow('\uD559\uC2B5 \uC9C4\uD589\uB960 \uCD08\uAE30\uD654', 'DAY\uBCC4 \uB2E8\uC5B4 \uD559\uC2B5 \uAE30\uB85D\uACFC \uC5F0\uC18D\uD559\uC2B5\uC774 \uCD08\uAE30\uD654\uB418\uC5C8\uC2B5\uB2C8\uB2E4.', function () {
        if (confirm('\uD559\uC2B5 \uC9C4\uD589\uB960\uACFC \uC5F0\uC18D\uD559\uC2B5 \uAE30\uB85D\uC744 \uBAA8\uB450 \uCD08\uAE30\uD654\uD560\uAE4C\uC694?')) {
          state.progress = {};
          state.studyLog = [];
          saveState();
          render();
          showToast('\uD559\uC2B5 \uC9C4\uD589\uB960\uC774 \uCD08\uAE30\uD654\uB418\uC5C8\uC2B5\uB2C8\uB2E4');
        }
      }),
    ...
    wrap.appendChild(h('div', { class: 'settings-group' }, [
      ...
      h('div', { class: 'settings-row' }, [
        h('div', { class: 'settings-row-text' }, [
          ...
          text('div', 'settings-row-desc', '\uD559\uC2B5 \uAE30\uB85D, \uD034\uC988 \uC810\uC218, \uC624\uB2F5\uB178\uD2B8, \uC990\uACA8\uCC3E\uAE30\uB97C \uBAA8\uB4E0 \uC0AD\uC81C\uD574\uC694. \uB418\uB3CC\uB9B4 \uC218 \uC5C6\uC5B4\uC694.')
        ]),
        h('button', {
